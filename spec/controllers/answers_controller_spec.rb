...
RSpec.describe AnswersController, type: :controller do
  ...
  describe 'PATCH #update' do
    ...
    it 'assigns the requested answer to @answer' do
      patch :update, params: { id: answer, question_id: answer.question, answer: attributes_for(:answer) }, format: :js
      expect(assigns(:answer)).to eq answer
    end

    it 'changes answer attributes' do
      patch :update, params: { id: answer, question_id: answer.question, answer: { body: 'new body' } }, format: :js
      answer.reload
